...
<head>
    ...
    <link rel="stylesheet" href="css/estilo-mp-produto.css">
...
?>
    ...
    <section class="container sproduct my-5 pt-2">
        <div class="row mt-5">
            ...
            <img class="img-fluid w-100 pb-1" src="../imagens/produto-mk.svg" id="MainImg" alt="Imagem 1">
        </div>

            <div class="col-lg-6 col-md-12 col-12">
                <div class="lance">
                    <h3 class="py-4">Produto</h3>
                    <h2>R$100</h2>
                </div>
                <button class="buy-btn mt-5">COMPRAR</button>
